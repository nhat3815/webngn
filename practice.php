...
<html lang="en">
  ...
  <body>
    ...
    <section class="ftco-cover overlay" style="background-image: url(images/image_8.1.jpg);" id="section-home" data-aos="fade"  data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row align-items-center justify-content-center ftco-vh-100">
          <div class="col-md-9 text-center">
            <h1 class="ftco-heading mb-4" data-aos="fade-up" data-aos-delay="500">Your IT Solutions - Your IT Partner</h1>
