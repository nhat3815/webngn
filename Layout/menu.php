				...
				<div class="navbar-header">
				   <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
				    ...
				    <div class="navbar-brand navbar-bg">
					    <a href="index.html">
					    	<img class="img-responsive" src="images/Logo.png" alt="logo" style="height: 45px;padding: 1px 0 0 0;width: 100px;">
					    </a> 
				    </div>                   
				</div><!--/ Logo end -->
...
<li><a href="index-4.html">Home 4</a></li> -->
						...
						<li class="dropdown">
                       		...
                       		<div class="dropdown-menu">
								<ul>
		                            <li><a href="../webngn/programs/certified-network-defender-cnd.php">CND: Certified Network Defender</a></li>
