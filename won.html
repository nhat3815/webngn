...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a href="won.html" class="nav-link">Won Cases</a></li>
    ...
    <section class="ftco-cover overlay" style="background-image: url(images/bg_4.jpg);" id="section-home" data-aos="fade"  data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row align-items-center justify-content-center ftco-vh-100">
          <div class="col-md-9 text-center">
            <h1 class="ftco-heading mb-4" data-aos="fade-up" data-aos-delay="500">Won Cases</h1>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-4">
            <div class="block-10">
              <div class="won-img mb-3" style="background-image: url(images/image_5.jpg);"></div>
              <div class="person-info">
                <span class="name-2 mb-3">Even the all-powerful</span>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name</p>
                <span class="result">Result: Victory</span>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
            <div class="block-10">
              <div class="won-img mb-3" style="background-image: url(images/image_6.jpg);"></div>
              <div class="person-info">
                <span class="name-2 mb-3">Even the all-powerful</span>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name life One day however a small line of blind</p>
                <span class="result">Result: Victory</span>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
            <div class="block-10">
              <div class="won-img mb-3" style="background-image: url(images/image_7.jpg);"></div>
              <div class="person-info">
                <span class="name-2 mb-3">Even the all-powerful</span>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name</p>
                <span class="result">Result: Victory</span>
          ...
          <div class="col-sm-6 col-md-4">
            <div class="block-10">
              <div class="won-img mb-3" style="background-image: url(images/image_8.jpg);"></div>
              <div class="person-info">
                <span class="name-2 mb-3">Even the all-powerful</span>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name life One day however a small line of blind</p>
                <span class="result">Result: Victory</span>
          ...
          <div class="col-sm-6 col-md-4">
            <div class="block-10">
              <div class="won-img mb-3" style="background-image: url(images/image_9.jpg);"></div>
              <div class="person-info">
                <span class="name-2 mb-3">Even the all-powerful</span>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name</p>
                <span class="result">Result: Victory</span>
          ...
          <div class="col-sm-6 col-md-4">
            <div class="block-10">
              <div class="won-img mb-3" style="background-image: url(images/image_10.jpg);"></div>
              <div class="person-info">
                <span class="name-2 mb-3">Even the all-powerful</span>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name</p>
                <span class="result">Result: Victory</span>
